...
$(OUT_DIR)/rl_rlog.$(OBJ):$(rlSRCS)
	$(CC) $(COPTS) $(IOPTS) $(POPTS) $(IN_DIR)/rl_rlog.$(SRC) -o $(OUT_DIR)/rl_rlog.$(OBJ)
$(OUT_DIR)/rl_common.$(OBJ):$(rlSRCS)
	$(CC) $(COPTS) $(IOPTS) $(POPTS) $(IN_DIR)/rl_common.$(SRC) -o $(OUT_DIR)/rl_common.$(OBJ)
$(OUT_DIR)/rl_platform.$(OBJ):$(rlSRCS)
	$(CC) $(COPTS) $(IOPTS) $(POPTS) $(IN_DIR)/rl_platform.$(SRC) -o $(OUT_DIR)/rl_platform.$(OBJ)
