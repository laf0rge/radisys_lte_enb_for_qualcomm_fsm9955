...
C_SRC=$(patsubst %.o,%.c, $(subst $(OUT_DIR_NAME),$(IN_DIR),$(C_OBJS)))
CPP_SRC=$(patsubst %.o,%.cpp, $(subst $(OUT_DIR_NAME),$(IN_DIR),$(CPP_OBJS)))

all: $(C_OBJS) $(CPP_OBJS) 

$(C_OBJS): $(HEADER_FILES) $(C_SRC)
	@echo -e "Compiling $(COLOR)$(IN_DIR)/$(patsubst %.o,%.c, $(subst $(OUT_DIR_NAME)/,,$@)) $(REVERT)..."
	$(QUIET)$(CC) -c $(CCOPTS) -o $@ $(IN_DIR)/$(patsubst %.o,%.c, $(subst $(OUT_DIR_NAME),,$@))

$(CPP_OBJS): $(HEADER_FILES) $(CPP_SRC)
	@echo -e "Compiling $(COLOR)$(IN_DIR)/$(patsubst %.o,%.cpp, $(subst $(OUT_DIR_NAME)/,,$@)) $(REVERT)..."
	$(QUIET)$(CPP) -c $(CPPOPTS) -o $@ $(IN_DIR)/$(patsubst %.o,%.cpp, $(subst $(OUT_DIR_NAME),,$@))
