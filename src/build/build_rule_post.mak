...
C_SRC=$(patsubst %.o,%.i, $(subst $(OUT_DIR_NAME),$(OUT_DIR),$(C_OBJS)))
CPP_SRC=$(patsubst %.o,%.i, $(subst $(OUT_DIR_NAME),$(OUT_DIR),$(CPP_OBJS)))

all: $(C_OBJS) $(CPP_OBJS) $(C_OBJS_PRE) 

$(C_OBJS): $(HEADER_FILES) $(C_SRC1) $(C_OBJS_PRE)
	@echo -e "Compiling $(COLOR)$(OUT_DIR)/$(patsubst %.o,%.i, $(subst $(OUT_DIR_NAME)/,,$@)) $(REVERT)..."
	$(QUIET)$(CC) -c $(CCOPTS) -o $@ $(OUT_DIR)/$(patsubst %.o,%.i, $(subst $(OUT_DIR_NAME),,$@))

$(CPP_OBJS): $(HEADER_FILES) $(CPP_SRC)
	@echo -e "Compiling $(COLOR)$(IN_DIR)/$(patsubst %.o,%.i, $(subst $(OUT_DIR_NAME)/,,$@)) $(REVERT)..."
	$(QUIET)$(CPP) -c $(CPPOPTS) -o $@ $(OUT_DIR)/$(patsubst %.o,%.i, $(subst $(OUT_DIR_NAME),,$@))
