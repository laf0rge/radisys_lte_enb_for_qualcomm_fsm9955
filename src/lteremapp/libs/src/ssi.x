...
#elif defined(BC_CPUL_SHM_INST)
EXTERN S16 SAllocNew ARGS((Region region, Size *size, U32 flags, Data **ptr,U32 line, const U8 *fnName));
EXTERN S16 SFreeNew ARGS((Region region, Data *ptr, Size size, U32 line,const U8 *fnName));
#else
#ifdef T2K_MEM_LEAK_DBG
