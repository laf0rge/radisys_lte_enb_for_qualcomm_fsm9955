...
/** @brief Down Link Scheduler information */  
  union   rgrDlSchInfoS
   {
     RgrCellPfs        cellDlPfs;      /*!< Information related to DL PFS 
                                          Scheduler */
   } dlSchInfo;
   U8                  ulSchdType;     /*!< Indicates which UL scheduler to use, range
                                          is 0..(number of schedulers - 1) */
/** @brief Up Link Scheduler information */  
  union               rgrUlSchInfoS
   {
      RgrCellPfs      cellUlPfs;       /*!< This structure holds the parameters   
...
#endif /* LTE_TDD*/
/** @} */
EXTERN S16 cmPkRgrCellPfs ARGS((
   RgrCellPfs           *param,
   Buffer               *mBuf
));
EXTERN S16 cmUnpkRgrCellPfs ARGS((
   RgrCellPfs           *param,
   Buffer               *mBuf
));
