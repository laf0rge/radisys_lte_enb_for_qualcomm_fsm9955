...
PUBLIC void RemoveFromT2kMemLeakInfo ARGS((U32 address, char *file, U32 line));
...
#endif
{
   ...
   /* Pool-2 and Pool-3 are not actively used in T3300 and the number of 
    * blocks in pool-2 are 800 after cellup on T3300 FDD with ICC part size 
    * 573; this fixed number check may need decrease if we are reducing 
    * ICC the part size */
