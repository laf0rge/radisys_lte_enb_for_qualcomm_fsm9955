...
#define ENTQURX     0xea             /* Qualcom  Rx */
#define ENTQUTX     0xeb             /* Qualcom  Tx*/

#define ENTNL       0xec             /* LTE SON Feature */
...
#define MODIDNC       0xFF              /* MODULEID not configured */
...
#elif defined(SS_MEM_LEAK_DETEC_LEVEL1) || defined(SS_DEBG_MEM_CORRUP_LEVEL1) || defined(SS_LIGHT_MEM_LEAK_STS)
...
#define SGetSBuf(region, pool, bufPtr, size) SGetSBufNew(region,pool,bufPtr,size, __LINE__,(const U8 *) __func__)
#define SGetMsg(region, pool, mBufPtr) SGetMsgNew(region, pool, mBufPtr, __LINE__, (const U8 *)__func__)
#define SGetDBuf(region, pool, bufPtr) SGetDBufNew(region,pool,bufPtr, line, fnName)
#define SPutSBuf(region, pool, buf, size) SPutSBufNew(region, pool, buf, size, __LINE__, (const U8 *)__func__)
#define SPutMsg(mBuf) SPutMsgNew(mBuf, __LINE__,  (const U8 *)__func__)
#define SPutDBuf(region, pool, buf) SPutDBufNew(region, pool, buf, line, fnName)
#define ssUpdDBuf(region, size, dBuf, dataptr, remIpHdr) ssUpdDBufNew(region, size, dBuf, dataptr, remIpHdr, __LINE__, (const U8 *)__func__)
#define ssGetDBufOfSize(region, size, dBuf) ssGetDBufOfSizeNew(region, size, dBuf, __LINE__, (const U8 *)__func__)
#define SAddPreMsgMult(src, cnt, mBuf) SAddPreMsgMultNew(src, cnt, mBuf, __LINE__, (const U8 *)__func__)
#define SInitMsg(mBuf) SInitMsgNew(mBuf, __LINE__, (const U8 *)__func__)
#define SAddPreMsgMultInOrder(src, cnt, mBuf) SAddPreMsgMultInOrderNew(src, cnt, mBuf,__LINE__, (const U8 *)__func__)
#define SAddPreMsg(data, mBuf) SAddPreMsgNew(data, mBuf, __LINE__, (const U8 *)__func__)
#define SAddPstMsg(data, mBuf) SAddPstMsgNew(data, mBuf, __LINE__, (const U8 *)__func__)
#define SRemPreMsg(dataPtr, mBuf) SRemPreMsgNew(dataPtr, mBuf, __LINE__, (const U8 *)__func__) 
#define SRemPstMsgMult(dst, cnt, mBuf) SRemPstMsgMultNew(dst, cnt, mBuf, __LINE__, (const U8 *)__func__)
#define SAddPstMsgMult(src, cnt, mBuf) SAddPstMsgMultNew(src, cnt, mBuf, __LINE__, (const U8 *)__func__)
#define SRemPreMsgMult(dst, cnt, mBuf) SRemPreMsgMultNew(dst, cnt, mBuf, __LINE__, (const U8 *)__func__)
#define SCpyMsgMsg(mBuf, region, pool, dstBuf) SCpyMsgMsgNew(mBuf, region, pool, dstBuf, __LINE__, (const U8 *)__func__)
#define SAddMsgRef(mBuf, region, pool, dstBuf) SAddMsgRefNew(mBuf, region, pool, dstBuf, __LINE__, (const U8 *)__func__)
#define SRepMsg(data, mBuf, idx) SRepMsgNew(data, mBuf, idx, __LINE__, (const U8 *)__func__)
#define SCompressMsg(mBuf) SCompressMsgNew(mBuf, __LINE__, (const U8 *)__func__)
#define SCpyPartMsg(srcBuf, idx, cnt, dstBuf)  SCpyPartMsg(srcBuf, idx, cnt, dstBuf, __LINE__, (const U8 *)__func__)
#define SMovPartMsg(srcBuf, idx, dstBuf)  SMovPartMsgNew(srcBuf, idx, dstBuf, __LINE__, (const U8 *)__func__)
#define SGetFlatBuf(region, ptr, size) SGetFlatBufNew(region, ptr, size, __LINE__,(const U8 *) __func__) 
#define SPutFlatBuf(region, ptr) SPutFlatBufNew(region, ptr, __LINE__, (const U8 *)__func__)
#define bcSPutMsg(mBuf) bcSPutMsgNew(mBuf,__LINE__, (const U8 *)__func__)
#define bcIcpuSharedDBufFree(buf) bcIcpuSharedDBufFreeNew(buf, __LINE__, (const U8 *)__func__)
#define SAddEgtpuHdr(src, cnt, mBuf) SAddEgtpuHdrNew(src, cnt, mBuf, __LINE__, (const U8 *)__func__)
#define bcZucIntProtReq(pst, secInp, libTrans, mBuf) bcZucIntProtReqNew(pst, secInp, libTrans, mBuf, __LINE__, (const U8 *)__func__)
#define buildRecvBuf(info, len,  rxArr, dBuf, maxSize, msg, isStrmMsg) buildRecvBufNew(info, len,  rxArr, dBuf, maxSize, msg, isStrmMsg, __LINE__, (const U8 *)__func__)
#define buildRecvMsg(info, rxArr, numBuf, msgLen, dBufs, mPtr) buildRecvMsgNew(info, rxArr, numBuf, msgLen, dBufs, mPtr, __LINE__, (const U8 *)__func__)
#define bcIcpuAlloc(regionCb, size, flags, ptr) bcIcpuAllocNew(regionCb, size, flags, ptr, __LINE__, (const U8 *)__func__)
#define ssAllocB(size, pri) ssAllocBNew(size, pri, __LINE__, (const U8 *)__func__)
#define ssESBAlloc(base, size, pri, fr_rtn) ssESBAllocNew(base, size, pri, fr_rtn, __LINE__, (const U8 *)__func__ ) 
#define ssFreeB(mp) ssFreeBNew(mp, __LINE__, (const U8 *)__func__)
#define DupMsg(region, mp, reuse) DupMsgNew(region, mp, reuse, __LINE__, (const U8 *)__func__)


#if ((defined (IPV6_OPTS_SUPPORTED) && !defined (LOCAL_INTF)) || (!defined (IPV6_OPTS_SUPPORTED) && defined (LOCAL_INTF)))
#define cmInetRecvMsg(sockFd, fromAddr, info, mPtr, len, x, flags) cmInetRecvMsgNew(sockFd, fromAddr, info, mPtr, len, x, flags, __LINE__, (const U8 *)__func__)
#elif (defined (IPV6_OPTS_SUPPORTED) && defined (LOCAL_INTF))
#define cmInetRecvMsg(sockFd, fromAddr, info, mPtr, len, x, y, flags) cmInetRecvMsgNew(sockFd, fromAddr, info, mPtr, len, x, y, flags, __LINE__, (const U8 *)__func__)
#else
#define cmInetRecvMsg(sockFd, fromAddr, info, mPtr, len, flags) cmInetRecvMsgNew(sockFd, fromAddr, info, mPtr, len, flags, __LINE__, (const U8 *)__func__)
#endif
#define SFlushQueue(q) SFlushQueueNew(q, __LINE__, (const U8 *)__func__)
//#define cmPkFpPjuDatInd(pst, suId, pdcpId, buff) cmPkFpPjuDatIndNew(pst, suId, pdcpId, buff, __LINE__, (const U8 *)__func__)
#define cmUnpkFpPjuDatInd(func, pst, mBuf) cmUnpkFpPjuDatIndNew(func, pst, mBuf,  __LINE__, (const U8 *)__func__)
#define cmAllocNL(regionCb, size, flags, ptr) cmAllocNLNew(regionCb, size, flags, ptr, __LINE__, (const U8 *)__func__)
#define cmAlloc(regionCb, size, flags, ptr) cmAllocNew(regionCb, size, flags, ptr, __LINE__, (const U8 *)__func__)
#define cmFreeNL(regionCb, ptr, size) cmFreeNLNew(regionCb, ptr, size, __LINE__, (const U8 *)__func__)
#define SFree(region, mBuf, MSGSIZE) SFreeNew(region, mBuf, MSGSIZE, line, fnName)
#define SAlloc(region, size, flags, ptr) SAllocNew(region, size, flags, ptr, line, fnName)
#ifdef PJ_SEC_ASYNC
#define bcAesIntVerReq(pst, secInp, libTrans, mBuf, recvMacI) bcAesIntVerReqNew(pst, secInp, libTrans, mBuf, recvMacI, __LINE__, (const U8 *)__func__)
#define bcSnow3gIntVerReq(pst,secInp,libTrans,mBuf,recvMacI) bcSnow3gIntVerReqNew(pst,secInp,libTrans,mBuf,recvMacI, __LINE__, (const U8 *)__func__)
#define bcSnow3gIntProtReq(pst,secInp,libTrans,mBuf) bcSnow3gIntProtReqNew(pst,secInp,libTrans,mBuf, __LINE__, (const U8 *)__func__)
#define bcZucIntVerReq(pst,secInp,libTrans,mBuf,recvMacI) bcZucIntVerReqNew(pst,secInp,libTrans,mBuf,recvMacI, __LINE__, (const U8 *)__func__)
#define bcAesIntProtReq(pst,secInp,libTrans,mBuf) bcAesIntProtReqNew(pst,secInp,libTrans,mBuf, __LINE__, (const U8 *)__func__)
#else
#define bcAesIntVerReq(secInp, ueCb, mBuf, macI) bcAesIntVerReqNew(secInp, ueCb, mBuf, macI, __LINE__, (const U8 *)__func__)
#define bcSnow3gIntVerReq(secInp,ueCb,mBuf,macI) bcSnow3gIntVerReqNew(secInp,ueCb,mBuf,macI, __LINE__, (const U8 *)__func__)
#define bcSnow3gIntProtReq(secInp,ueCb,mBuf,macI) bcSnow3gIntProtReqNew(secInp,ueCb,mBuf,macI, __LINE__, (const U8 *)__func__) 
#define bcZucIntVerReq(secInp,ueCb,mBuf,macI) bcZucIntVerReqNew(secInp,ueCb,mBuf,macI, __LINE__, (const U8 *)__func__) 
#define bcAesIntProtReq(secInp,ueCb,mBuf,macI) bcAesIntProtReqNew(secInp,ueCb,mBuf,macI, __LINE__, (const U8 *)__func__)
#endif
#endif
...
#define PID_MAC_UL_SCHD               30210
#if 0
#define PID_CL_TTI_IND                1
#define PID_MAC_TTI_IND               100
#define PID_MAC_DL_SCHD               101
#define PID_MAC_SF_ALLOC_REQ          102
#define PID_PDCP_DL_PKT               300
#define PID_RLC_DL_CLEAN_MEM          400
#define PID_KRAIT_READ_PORT           450
#define PID_KRAIT_WRITE_PORT          451
#define PID_CL_ACTV_TSK               452
#define PID_MSG_FROM_PHY              453
#define PID_RG_ACTV_TSK               454
#define PID_SCH_ACTV_TSK              455
#define PID_KWDL_ACTV_TSK             456
#define PID_KWUL_ACTV_TSK             457
#define PID_PJDL_ACTV_TSK             458
#define PID_PJUL_ACTV_TSK             459
#define PID_KRAIT_MOD_PROCMSG         460
#define PID_KRAIT_MOD_READ_EVENT      461
#else
#define PID_CL_TTI_IND                801
#define PID_MAC_TTI_IND               800
#define PID_MAC_DL_SCHD               802
#define PID_MAC_SF_ALLOC_REQ          803
#define PID_PDCP_DL_PKT               804
#define PID_RLC_DL_CLEAN_MEM          805
#define PID_KRAIT_READ_PORT           806
#define PID_KRAIT_WRITE_PORT          807
#define PID_CL_ACTV_TSK               852
#define PID_MSG_FROM_PHY              853
#define PID_RG_ACTV_TSK               854
#define PID_SCH_ACTV_TSK              855
#define PID_KWDL_ACTV_TSK             856
#define PID_KWUL_ACTV_TSK             857
#define PID_PJDL_ACTV_TSK             858
#define PID_PJUL_ACTV_TSK             859
#define PID_KRAIT_MOD_PROCMSG         860
#define PID_KRAIT_MOD_READ_EVENT      861
#endif
#define PID_MAC_UE_CFG                30212
#define PID_MAC_UE_RECFG              30213
#define PID_MAC_UE_DEL                30214
