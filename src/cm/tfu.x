...
typedef struct tfuRawCqiRpt
{
   ...
   U8                     ri;            /*!< Array of bits comprising of a Rank */                                              
} TfuRawCqiRpt;
...
typedef struct tfuUePucchHqRecpInfo
{
   ...
   U16                    hqRes[TFU_MAX_TDD_HQ_RES]; /*!< (n^1PUCCH(0-3))
                                              values [0-2047] */ 
...
typedef struct tfuUePucchHqRecpInfo
{
   U16                    pucchIdx;      /*!< n^1Pucch for ACK/NACK [0-2047] */
   U8                     hqSz;          /*!< Size of feedback in bits [1/2] */
} TfuUePucchHqRecpInfo;
...
{
   U8                     cqiPmiSzR1;   /*!< Size of DL CQI/PMI in bits for
                                             rank 1 report[0-255] */
   U8                     cqiPmiSzRn1;  /*!< Size of DL CQI/PMI in bits for 
                                             rank > 1 report[0-255] */
   TknU8                  riSz;         /*!< Size of RI in bits[1-2]. Value will
   ...
   U8                     riBetaOff;     /*!< Beta offset for RI[0-15]. Given 
                                             by RRC */
   U8                     rptType;       /*!< Report Type 0 = periodic report 
                                          1 = aperiodic report */
   U8                     cqiPmiSz;      /*!< In 3GPP release 9, for periodic
                                           report we need only one size */
...
typedef union tfuDlCqiInfo
{
   ...
   TfuDlCqiPusch          puschCqi;      /*!< PUSCH CQI information */
} TfuDlCqiInfo;
...
#ifndef TFU_TDD
   TfuHqFdbk              isAck[TFU_MAX_TB];  /*!< For FDD, a single Feedback 
                                               per Codeword is present */
#else
...
#endif
   TfuHqFdbk              hqFbk[TFU_MAX_TB][4]; /*!< For TDD HARQ multiplexing, 
                                                     receive upto 4 feedbacks */
#endif /* TFU_TDD */
} TfuHqInfo;
#else
typedef struct tfuHqInfo
{
   ...
   U8                     noOfTbs;       /*!< Number of TBs */
#ifndef TFU_TDD
   U8                     isAck[TFU_MAX_TB];  /*!< For FDD, a single Feedback 
                                                   per Codeword is present */
#else
   U8                     M;             /*!< Number of feedbacks multiplexed */
   U8                     hqFbk[TFU_MAX_TB][4]; /*!< For TDD HARQ multiplexing, 
                                                     receive upto 4 feedbacks */
#endif /* TFU_TDD */
} TfuHqInfo;
#endif 
...
{
   CmLteCellId       cellId;       /*!< Cell ID */
   CmLteTimingInfo   timingInfo;   /*!< Timing information, that is, carries the SFN
                                     and subframe running at the physical layer.
                                     */
   Bool isDummyTti;                /*!< Flag to indicate the dummy TTIs */                       
