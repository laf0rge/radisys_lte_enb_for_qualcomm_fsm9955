...
#endif
{
   ...
   CMCHKPK(SPkU16, param->maxNumUe, mBuf);
   CMCHKPK(cmPkLteRnti, param->startRntiVal, mBuf);
...
#endif
{
   ...
   CMCHKUNPK(cmUnpkLteRnti, &param->startRntiVal, mBuf);
   CMCHKUNPK(SUnpkU16, &param->maxNumUe, mBuf);
...
/*ctf_c_001.main_1*/
   if(param->pres != FALSE)
   {
      CMCHKUNPK(SUnpkU32, (U32 *)&tmp, mBuf);
      param->ueCategory = (CmLteUeCategory)tmp;
